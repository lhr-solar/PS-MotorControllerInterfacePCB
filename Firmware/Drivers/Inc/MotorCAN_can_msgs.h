...
#define CAN_ID_MC_MOTOR_TEMPMEASUREMENT 0x50B
...
#define CAN_DLC_MC_15VRAILMEASUREMENT 8
#define CAN_DLC_MC_3V319VRAILMEASUREMENT 8
...
typedef struct {
    float MC_Supply15V;
} mc_15vrailmeasurement_t;

typedef struct {
    float MC_Supply1V9;
    float MC_Supply3V3;
} mc_3v319vrailmeasurement_t;
